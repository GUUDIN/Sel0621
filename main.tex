...
Da equação (2):
$$I_{Dlim} = \frac{\mu C_{ox} W}{L} \left(\frac{nU_T}{2}\right)^2$$

Para forte inversão, na corrente limite:
$$g_{m,forte} = \sqrt{2\mu C_{ox} \frac{W}{L} I_{Dlim}}$$
...
$$g_{m,fraca} = \frac{I_{Dlim}}{U_T} = \frac{\mu C_{ox} W}{L} \frac{nU_T}{2} \frac{1}{U_T} = \frac{\mu C_{ox} W n}{2L}$$
